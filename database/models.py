...
class TelegramUser(Base):
    ...
    created_at: Mapped[datetime.datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=lambda: datetime.datetime.now(datetime.timezone.utc))
...
class eMaktabUser(Base):
    ...
    telegram_id: Mapped[int] = mapped_column(BigInteger, ForeignKey(TelegramUser.telegram_id, ondelete="CASCADE"), nullable=False)
